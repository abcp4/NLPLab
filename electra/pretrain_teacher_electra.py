...
tokenizer,tokenized_dataset,norm,vocab=get_tokenizer(dataset,NUM_TOKENIZER_TRAINING_ITEMS,VOCAB_SIZE,TOKENIZER_PATH,model_training,MODEL_MAX_SEQ_LEN)

## Electra
from base_electra_model import Electra
from teacher_electra_model import Electra
